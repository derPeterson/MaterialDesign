package de.derpeterson.materialdesign.helper.css;
...
public class CssHelper {
     ...
     * @return the CssMetaData instance
     */
    public static <S extends Styleable, V> DefaultPropertyBasedCssMetaData<S, V> createMetaData(String property, StyleConverter<?, V> converter, String propertyName) {
        return new DefaultPropertyBasedCssMetaData<S, V>(property, converter, propertyName);
    }
